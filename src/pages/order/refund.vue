    ...
    <Container>
        ...
        <div style="background: #ffffff">
            ...
            <div class="refund-box">
                <div class="box">
                    <div class="order-remarks flex">
                        <div class="remarks-title">退款说明</div>
                        <textarea v-model="refundRemark" placeholder="请输入退款说明,100字以内" maxlength="100"
                                  class="textarea"></textarea>
                    </div>

                    <div class="order-remarks flex" style="margin-top: 20px">
                        <div class="remarks-title">上传凭证</div>
        ...
        <div class="flex" style="justify-content: flex-end;background-color: #ffffff;padding: 20px">
            <Button @click="submit" size="large" type="error">申请退款</Button>
        </div>
    ...
    methods: {
        submit() {
            ...
            orderApi.refundSubmit({
                ...
                price: this.refund_price.price,
                content: this.refundRemark,
        ...
        getData() {
            orderApi.orderRefund({
                ...
                success: (res) => {
                    ...
                    this.refund_type = res.refund_type
                }
            })
        },
        handleView(name) {
